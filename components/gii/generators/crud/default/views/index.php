...
<?= "<?php \n " ?>
    ...
    $panels = [
        'heading' => '<h3 class="panel-title"><i class="glyphicon glyphicon-book"></i> Lista de  ' . $this->title . '</h3>',
...
?>
        [
            ...
            'dropdown' => false,
            'vAlign' => 'middle',
            'viewOptions' => ['title' => 'view', 'data-toggle' => 'tooltip', 'title'=>'Visualizar'],
            'updateOptions' => ['title' => 'update', 'data-toggle' => 'tooltip',  'title'=>'Atualizar'],
            'deleteOptions' => ['title' => 'delete', 'data-toggle' => 'tooltip',  'title'=>'Deletar'],
        ],
        [
