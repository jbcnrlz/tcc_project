...
?>
    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
              <?= "<?= " ?> Html::a('Fechar',"/admin/".Yii::$app->controller->id,['class' => 'btn btn-default']); ?>
             <?= "<?= " ?> Html::a('Adicionar Novo',"/admin/".Yii::$app->controller->id."/create",['class' => 'btn btn-success']); ?>
             <?= "<?= " ?> Html::a('Editar',"/admin/".Yii::$app->controller->id."/update?id=".$model->id,['class' => 'btn btn-primary']); ?>
