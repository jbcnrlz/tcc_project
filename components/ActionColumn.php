...
class ActionColumn extends Column
{
     ...
     * @see buttons
     */
    public $template = '{visualizar} {atualizar} {delete}';
    /**
    ...
    {
        if (!isset($this->buttons['visualizar'])) {
            $this->buttons['visualizar'] = function ($url, $model, $key) {
                $options = array_merge([
        ...
        if (!isset($this->buttons['atualizar'])) {
            $this->buttons['atualizar'] = function ($url, $model, $key) {
                $options = array_merge([
