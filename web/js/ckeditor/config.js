...
//config.plugins = 'dialogui,dialog,dialogadvtab,basicstyles,bidi,button,panelbutton,panel,floatpanel,colorbutton,colordialog,menu,contextmenu,toolbar,enterkey,entities,popup,filebrowser,fakeobjects,floatingspace,listblock,richcombo,font,format,horizontalrule,htmlwriter,wysiwygarea,image,indent,indentblock,indentlist,justify,menubutton,link,list,liststyle,magicline,pagebreak,pastefromword,preview,removeformat,showblocks,showborders,sourcearea,tab,table,tabletools,undo,lineutils,widget';
//config.plugins = 'widget,dialog',
config.plugins = 'basicstyles,colorbutton,toolbar,enterkey,entities,popup,filebrowser,fakeobjects,floatingspace,listblock,richcombo,font,format,horizontalrule,htmlwriter,wysiwygarea,image,indent,indentblock,indentlist,justify,menubutton,link,list,liststyle,magicline,pastefromword,preview,removeformat,showblocks,showborders,sourcearea,tab,table,tabletools,undo,lineutils';
...
config.toolbar = [
		...
		{ name: 'styles', items: ['btgrid', 'Styles', 'Format',  'FontSize' ] },
