...
$this->title = "Calendário Acadêmico";
     ...
     echo GridView::widget([
        ...
        'columns' => [
         ...
         [
            ...
            ['attribute'=>'date', 'width'=>'','format'=>['date',(isset(Yii::$app->modules['datecontrol']['displaySettings']['date'])) ? Yii::$app->modules['datecontrol']['displaySettings']['date'] : 'd-m-Y']],
