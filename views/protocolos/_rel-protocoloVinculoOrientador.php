<div id="relatorio">
    ...
    <div class="row text-center titulo">
        <h4 class="text-center"><strong>VÍNCULO DE ORIENTAÇÃO DE PROJETO DE GRADUAÇÃO</strong></h4>
    </div>
    <div class="row">
    ...
    <div class="row">
        <table class="tabelaRel">
            <tr>
                <td>
                    <strong>Sugestão de Orientador:</strong> <?=@$model->projeto->orientadorSugestao->nome; ?> 
                </td>                  
