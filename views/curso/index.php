        ...
        'columns' => [
           [
            ...
            'rowSelectedClass' => GridView::TYPE_DANGER,
                ...
                'pageSummary' => true,
                'readonly' => false,
                'content' => function($data){return '<div class="text_content">'.htmlentities($data->id).'</div>';},
                'editableOptions' => [
                   ...
                   [
                'class' => 'kartik\grid\EditableColumn',
                'attribute' => 'nome_abreviado',
                'width'=>'',
                'pageSummary' => true,
                'readonly' => false,
                'content' => function($data){return '<div class="text_content">'.htmlentities($data->nome_abreviado).'</div>';},
                'editableOptions' => [
                    'inputType' => Editable::INPUT_TEXT,
                    'asPopover' => true,
                ...
                'pageSummary' => true,
                'readonly' => false,
                'content' => function($data){return '<div class="text_content">'.htmlentities($data->nome).'</div>';},
                'editableOptions' => [
                    'inputType' => Editable::INPUT_TEXT,
                    'asPopover' => true,
                ...
                'pageSummary' => true,
                'readonly' => false,
                'content' => function($data){return '<div class="text_content">'.htmlentities($data->coordenador).'</div>';},
                'editableOptions' => [
                    'inputType' => Editable::INPUT_TEXT,
                    'asPopover' => true,
