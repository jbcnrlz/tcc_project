...
$this->title = "Mural de Recados";
$this->params['breadcrumbs'][] = Html::decode($this->title);
?>


<div class="mural-recados-index">
     ...
     echo GridView::widget([
        ...
        'columns' => [
         ...
         [
                    ...
                    'width'=>''],
            ['attribute'=>'dta_notificacao', 'width'=>'','format'=>['date',(isset(Yii::$app->modules['datecontrol']['displaySettings']['date'])) ? Yii::$app->modules['datecontrol']['displaySettings']['date'] : 'd-m-Y']],
            ['attribute'=>'dta_termino_visualizacao', 'width'=>'','format'=>['date',(isset(Yii::$app->modules['datecontrol']['displaySettings']['date'])) ? Yii::$app->modules['datecontrol']['displaySettings']['date'] : 'd-m-Y']],
