...
$botaoFiltro = '
                <a class="btn btn-warning isDisabled" href="/projeto/cadastrar" data-pjax="0"><i class="glyphicon glyphicon-plus"></i> Adicionar</a>
                 <div class="clear-fix"></div>
                 <div class="filtro" style="margin-right:10px; margin-top:10px;">
                 
                <form name="filtroGrid" action="/projeto/index" class="form-stylo" method="post">
...
'vAlign' => GridView::ALIGN_MIDDLE,                 
         ...
         [
                    ...
                    'format'=>'raw',
                    'value'=> function($data){
                        return (!$data->orientador =='' )?$data->orientador->nome:'<div class="label label-warning" style="font-weight:normal">Sem Orientador</div>';
                    },
                    'width'=>''],
            [
             'attribute'=>'status',
             ...
             'value'=>function($data){
                       if($data->status == 1){
                         return "<span class='glyphicon glyphicon-time text-primary size-icone' data-toggle='tooltip' data-original-title='Em Processo'></span>";
                       }else if($data->status == 2){
                           return "<span class='glyphicon glyphicon-education text-success size-icone' data-toggle='tooltip' data-original-title='Concluído'></span>"; 
                       }else{
                           return "<span class='glyphicon glyphicon-ban text-info size-icone' data-toggle='tooltip' data-original-title='Cancelado'></span>"; 
                       }
             }
            ...
            [
                ...
                'template'=>'{protocolos}{view}{update}{del}',
                 'dropdown' => false,
                 'vAlign' => 'middle',
                  'width' => '150px',
                ...
                'buttons'=>[
                     'protocolos' => function ($url, $model) {
    return Html::a('<span class="glyphicon glyphicon glyphicon-tag"></span>', ['/protocolos/cadastrar?idp='.$model->id], [
                                                                      'title' => 'Adicionar Protocolo',
                                                                      'data-toggle' => 'tooltip',
                                                                      'disabled'=>!Mimin::checkRoute('/protocolos/cadastrar'),
