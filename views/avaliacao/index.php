...
$this->title = "Avaliação da Apresentação";
    ...
    <?php Pjax::begin(['id' => 'gridData','options'=>[
     ...
     echo GridView::widget([
        ...
        'columns' => [
         ...
         [
                    'attribute' => 'num_questao',
                    'width'=>''],
         [
                    'attribute' => 'apresentacao_id',
                    'width'=>''],
         [
                    'attribute' => 'questao',
                    'width'=>''],
         [
                    'attribute' => 'orientador_nota',
                    'width'=>''],
         [
                    'attribute' => 'convidado_primario_nota',
                    'width'=>''],
         [
                    'attribute' => 'convidado_secundario_nota',
                    'width'=>''],
